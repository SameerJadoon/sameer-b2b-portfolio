    ...
    <main>
      ...
      <section id="top" className="hero container">
        <div className="heroCopy">
          ...
          <h1>
            Turn the right prospects into <em>sales conversations.</em>
          </h1>

          <p className="heroText">
            I help B2B agencies, SaaS companies, and service businesses
            identify qualified prospects, build targeted lists, and create
            thoughtful outbound campaigns.
          </p>
      ...
      <section id="work" className="section container">
        <div className="sectionHead">
          ...
          <p>
            Focused outbound systems built around the right audience, message,
            and data.
          </p>
        </div>
        ...
        <div className="caseGrid">
          <article className="caseCard featured">
            ...
            <p>
              ...
              lead verification and personalized outreach angles.
            </p>
          ...
          <article className="caseCard">
            ...
            <p>
              Segmented prospect research designed to put a relevant offer in
              front of businesses with a clear reason to talk.
            </p>
          ...
          <article className="caseCard">
            ...
            <p>
              From market research and qualification to clean contact data and
              concise outbound messaging.
            </p>
        ...
        <div className="container">
          <div className="sectionHead light">
            <div>
              ...
              <h2>Outbound, without the guesswork.</h2>
            </div>

            <p>
              A practical workflow that keeps targeting and message quality at
              the center.
            </p>
          </div>
          ...
          <div className="serviceGrid">
            {[
              [
                "01",
                "ICP Research",
                "Define exactly who should be targeted and why.",
              ],
              [
                "02",
                "B2B Lead Generation",
                "Find relevant companies and the people who matter.",
              ],
              [
                "03",
                "Lead Verification",
                "Clean prospect data before it reaches your campaign.",
              ],
              [
                "04",
                "Cold Email Copywriting",
                "Write concise, relevant messages built for replies.",
              ],
              [
                "05",
                "Campaign Setup",
                "Organize outreach in modern outbound platforms.",
              ],
              [
                "06",
                "Optimization",
                "Use campaign signals to improve targeting and messaging.",
              ],
            ].map(([n, title, text]) => (
        ...
        <div className="processGrid">
          {[
            [
              "01",
              "Research",
              "Understand the market, offer and ideal customer.",
            ],
            [
              "02",
              "Build",
              "Create a focused list of relevant accounts and contacts.",
            ],
            [
              "03",
              "Verify",
              "Check and clean data before outreach.",
            ],
            [
              "04",
              "Personalize",
              "Develop relevant angles and concise messaging.",
            ],
            [
              "05",
              "Launch",
              "Run a controlled outbound campaign.",
            ],
            [
              "06",
              "Optimize",
              "Review signals and refine the system.",
            ],
          ].map(([n, title, text]) => (
          ...
          <div className="credentialGrid">
            ...
            <article className="credentialCard">
              ...
              <div className="credentialBody">
                ...
                <p>
                  Professional training in B2B business development and sales
                  fundamentals.
                </p>
      ...
      <section id="about" className="section about container">
        <div>
          ...
          <h2>
            Focused on the work behind a better outbound pipeline.
          </h2>
        </div>
        ...
        <div>
          ...
          <p>
            Tools I work with include LinkedIn Sales Navigator, Apollo,
